...
#define ncx_texture_create(PATH, WRAP_MODE, MIN_FILTER, MAG_FILTER, MIPMAP) ncx_texture_create_internal(PATH, WRAP_MODE, MIN_FILTER, MAG_FILTER, MIPMAP, __FILE__, __LINE__)
