...
/**
 * @brief Enum for each of the mouse buttons.
 ********************************************/
...
/**
 * @brief Enum for each of the input states (pressed, held, released)
 ********************************************************************/
enum input_state {
	NCX_PRESS,
	NCX_HOLD,
...
/**
 * @brief Initializes a GLFW context, and loads all OpenGL functions for use.
...
/**
 * @brief Terminates the GLFW context set up by 'ncx_init()'.
 *****************************************************/
void ncx_terminate(void);

/**
 * @brief Returns the current time of the application's runtime.
 ********************************************************/
float ncx_time(void);

/**
 * @brief Initializes the delta time variables.
 *
...
/**
 * @brief Returns the current calculated delta-time.
 *******************************************/
float ncx_time_delta(void);

/**
 * @brief Returns whether a specified key is pressed, held, or released.
...
/**
 * @brief Returns whether a specified mouse button is pressed, held,
 * or released.
...
/**
 * @brief Swap the front and back buffers to start working on the next frame.
 ********************************************************************/
void ncx_buffer_swap(void);

/**
 * @brief Returns whether the window is currently running or not.
 *********************************************************/
uint8_t ncx_window_is_running(void);

/**
 * @brief Mark the window for closing next time the loop runs.
 ******************************************************/
